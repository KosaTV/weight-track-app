...
<template>
	<div class="profile-section">
		<button class="section-close-btn" @click="() => switchSection(sectionId.previous)">
					...
					<section class="profile profile--in-section">
						<div class="img-section img-section--in-section">
							<div class="profile-cnt profile-cnt--in-section">
								<label class="img-upload-field" for="profile-section-img">
									<span class="img-upload-field__icon">
										<ion-icon name="camera-outline"></ion-icon>
									</span>
								</label>
								<input class="file-input" type="file" name="profile-section-img" ref="imgInput" id="profile-section-img" @change="prepareNewProfileImage" />
